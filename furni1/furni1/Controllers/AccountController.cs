...
namespace furni1.Controllers
{
    public class AccountController : Controller
    {
        ...
        public async Task<IActionResult> ForgotPassword(ForgotPasswordVM model)
        {
            ...
            await _emailSender.SendEmailAsync("unknowngirl621n@gmail.com", model.Email, "Reset Password", $"Please reset your password by clicking <a href='{callbackUrl}'>here</a>.");
